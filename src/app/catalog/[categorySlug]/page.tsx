...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return { title: `Produk ${category}`, description: `Jelajahi produk kategori ${category} dalam Batch PO aktif Serahin.`, alternates: { canonical: `/catalog/${categorySlug}` } };
}
