        ...
        <div className="overflow-x-auto max-h-96">
              ...
              {pageLogs.map((l) => {
                ...
                return (
                  <tr key={l.id} className="hover:bg-sand-50">
                    <td className="px-5 py-3 text-sand-600">{formatWaktu(l.createdAt)}</td>
                    <td className="px-5 py-3 text-sand-700">{IMPORT_MODE_LABEL[l.mode]}</td>
                    ...
                    <td className="px-5 py-3 text-sand-700">{l.jumlahSukses} / {l.jumlahDilewati}</td>
                    <td className="px-5 py-3">
                      <span
          ...
          <div className="flex justify-center items-center gap-3 py-3">
            <button
              ...
              disabled={page === 1}
              className="rounded-lg px-4 py-2 text-sm bg-sand-100 text-sand-700 disabled:opacity-50 hover:bg-sand-200"
            >
              ← Prev
            </button>
